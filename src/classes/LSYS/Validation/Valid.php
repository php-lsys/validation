...
class Valid {
	...
	/**
	 * compare number
	 * @param number $left_operand
	 * @param number $right_operand
	 * @param string $type
	 * @return boolean
	 */
	public static function comp($left_operand,$right_operand,$type='='){
		...
		switch ($type){
			case '=':
			case '==':
				if (extension_loaded("bcmath")&&is_string($left_operand)||is_string($right_operand)){
					return bccomp($left_operand, $right_operand)==0;
				}
